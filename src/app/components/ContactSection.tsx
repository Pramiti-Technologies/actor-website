    ...
    <section id="contact" className="min-h-screen py-20 px-6 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <div>
              <h3 className="text-3xl mb-6 text-ivory">Contact Information</h3>
              <div className="space-y-4">
                <a
                  href="mailto:contact@prashanthkrishnamoorthy.org"
                  className="flex items-center gap-4 p-4 rounded-lg border border-amber/20 hover:border-amber/50 hover:bg-charcoal/50 transition-all duration-300 group"
                >
                  <div className="w-12 h-12 rounded-full bg-burgundy/20 flex items-center justify-center group-hover:bg-burgundy/30 transition-colors">
                    <Mail className="w-6 h-6 text-burgundy" />
                  </div>
                  <div>
                    <p className="text-warm-grey text-sm">Email</p>
                    <p className="text-ivory">contact@prashanthkrishnamoorthy.org</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <p className="text-warm-grey text-sm">Phone</p>
                    <p className="text-ivory">+1 848-468-3766</p>
                  </div>
                </a>
              </div>
            </div>
            ...
            <div>
              <h4 className="text-xl mb-4 text-ivory">Follow Me</h4>
            ...
            <div className="pt-8 border-t border-amber/20">
              <h4 className="text-xl mb-4 text-ivory">Representation</h4>
              <div className="text-warm-grey space-y-2">
                <p>Agency Name</p>
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <form className="space-y-6 bg-charcoal border border-amber/20 rounded-lg p-8" onSubmit={handleSubmit}>
              <div>
              ...
              <div>
                <label htmlFor="subject" className="block text-ivory mb-2">
                  Subject
                </label>
                <input
                  type="text"
